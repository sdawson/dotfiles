...
hi Question     guifg=#cffbab guibg=NONE    gui=bold
...
hi StatusLine   guifg=#f8f8f2 guibg=#455354 gui=bold
hi StatusLineNC guifg=#000000 guibg=#808080 gui=italic
hi VertSplit    guifg=#404c4c guibg=#000000 gui=NONE
